    ...
    return (
        ...
        <div class="bg text-white w-full">
                <div className='w-full flex flex-col justify-center items-center'>
                    ...
                    <div className='md:w-[65%] w-[90%] flex justify-center items-center flex-wrap text-4xl sm:text-5xl md:text-6xl lg:text-7xl md:gap-[1rem] gap-[0.75rem] pt-3 pb-[2rem] font-bold'>
                        <p>Quality </p>
