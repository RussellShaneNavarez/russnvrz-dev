        ...
        <div class="bg text-white w-full">
                <div className='w-full flex flex-col justify-center items-center'>
                    ...
                    <div className='md:w-[65%] w-[90%]'>
                        <p className='text-md text-stone-400 font-medium text-center'>Hi, I'm Russell, I create intuitive, visually stunning and highly functional web applications.</p>
                    </div>
                    <div className='flex p-4 gap-3'>
                        <button className='flex see-my-work-btn gap-[0.25rem]' onClick={scrollToProjects}>
                            <p className="font-medium">See My Work</p>
                        ...
                        <button className='flex items-center gap-[0.75rem]' onClick={openPdf}>
                            ...
                            <p className="hover:text-stone-400 font-medium">Download CV</p>
                        </button>
                    </div>
                </div>
